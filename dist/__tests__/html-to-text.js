...
describe('html-to-text', () => {
    describe('.fromString()', () => {
        describe('wordwrap option', () => {
            ...
            it('should wordwrap at 80 characters by default', () => {
                expect(html_to_text_1.fromString(longStr)).toEqual('111111111 222222222 333333333 444444444 555555555 666666666 777777777 888888888\n999999999');
            });
            it('should wordwrap at given amount of characters when give a number', () => {
                expect(html_to_text_1.fromString(longStr, { wordwrap: 20 })).toEqual('111111111 222222222\n333333333 444444444\n555555555 666666666\n777777777 888888888\n999999999');
                expect(html_to_text_1.fromString(longStr, { wordwrap: 50 })).toEqual('111111111 222222222 333333333 444444444 555555555\n666666666 777777777 888888888 999999999');
                expect(html_to_text_1.fromString(longStr, { wordwrap: 70 })).toEqual('111111111 222222222 333333333 444444444 555555555 666666666 777777777\n888888888 999999999');
            });
            it('should not wordwrap when given null', () => {
                expect(html_to_text_1.fromString(longStr, { wordwrap: null })).toEqual(longStr);
            });
            it('should not wordwrap when given false', () => {
                expect(html_to_text_1.fromString(longStr, { wordwrap: false })).toEqual(longStr);
            });
            it('should not exceed the line width when processing embedded format tags', () => {
                ...
                expect(html_to_text_1.fromString(testString, {})).toEqual("This text isn't counted when calculating where to break a string for 80\ncharacter line lengths.");
            });
            it('should work with a long string containing line feeds', () => {
                ...
                expect(html_to_text_1.fromString(testString, {})).toEqual('If a word with a line feed exists over the line feed boundary then you must\nrespect it.');
            });
            ...
            it('should not exceed the line width when processing anchor tags', () => {
                ...
                expect(html_to_text_1.fromString(testString, {})).toEqual("We appreciate your business. And we hope you'll check out our new products\n[http://example.com/]!");
            });
            it('should honour line feeds from a long word across the wrap, where the line feed is before the wrap', () => {
                ...
                expect(html_to_text_1.fromString(testString, {})).toEqual('This string is meant to test if a string is split properly across a\nnewlineandlongword with following text.');
            });
            it('should remove line feeds from a long word across the wrap, where the line feed is after the wrap', () => {
                ...
                expect(html_to_text_1.fromString(testString, {})).toEqual('This string is meant to test if a string is split properly across\nanewlineandlong word with following text.');
            });
        });
        describe('preserveNewlines option', () => {
            ...
            it('should not preserve newlines by default', () => {
                expect(html_to_text_1.fromString(newlineStr)).not.toContain('\n');
            });
            it('should preserve newlines when provided with a truthy value', () => {
                expect(html_to_text_1.fromString(newlineStr, { preserveNewlines: true })).toContain('\n');
            });
            it('should not preserve newlines in the tags themselves', () => {
                var output_text = html_to_text_1.fromString(newlineStr, {
            ...
            it('should preserve line feeds in a long wrapping string containing line feeds', () => {
                const testString = '<p>If a word with a line feed exists over the line feed boundary then\nyou\nmust\nrespect it.</p>';
                expect(html_to_text_1.fromString(testString, { preserveNewlines: true })).toEqual('If a word with a line feed exists over the line feed boundary then\nyou\nmust\nrespect it.');
            });
            ...
            it('should preserve line feeds in a long string containing line feeds across the wrap with a line feed before 80 chars', () => {
                const testString = '<p>This string is meant to test if a string is split properly across a\nnewlineandlongword with following text.</p>';
                expect(html_to_text_1.fromString(testString, { preserveNewlines: true })).toEqual('This string is meant to test if a string is split properly across a\nnewlineandlongword with following text.');
            });
            it('should preserve line feeds in a long string containing line feeds across the wrap with a line feed after 80 chars', () => {
                const testString = '<p>This string is meant to test if a string is split properly across anewlineandlong\nword with following text.</p>';
                expect(html_to_text_1.fromString(testString, { preserveNewlines: true })).toEqual('This string is meant to test if a string is split properly across\nanewlineandlong\nword with following text.');
            });
            it('should split long lines', () => {
                ...
                expect(html_to_text_1.fromString(testString, { preserveNewlines: true })).toEqual('If a word with a line feed exists over the line feed boundary then you must\nrespect it.');
            });
        });
        describe('single line paragraph option', () => {
            ...
            it('should not use single new line when given null', () => {
                expect(html_to_text_1.fromString(paragraphsString, {
    ...
    describe('tables', () => {
      ...
      ';
            ...
            const result = html_to_text_1.fromString(html, { tables: true });
    ...
    describe('a', () => {
        it('should decode html attribute entities from href', () => {
            const result = html_to_text_1.fromString('<a href="/foo?a&#x3D;b">test</a>');
            expect(result).toEqual('test [/foo?a=b]');
        });
        it('should strip mailto: from email links', () => {
            const result = html_to_text_1.fromString('<a href="mailto:foo@example.com">email me</a>');
            expect(result).toEqual('email me [foo@example.com]');
        });
        it('should return link with brackets', () => {
            const result = html_to_text_1.fromString('<a href="http://my.link">test</a>');
        ...
        it('should not return link for anchor if noAnchorUrl is set to true', () => {
            const result = html_to_text_1.fromString('<a href="#link">test</a>', {
                noAnchorUrl: true
            });
    ...
    describe('lists', () => {
        ...
        describe('ol', () => {
            ...
            it('should handle an ordered list with multiple elements', () => {
                ...
                expect(html_to_text_1.fromString(testString)).toEqual(' 1. foo\n 2. bar');
            });
            ...
            it('should support the ordered list type="a" attribute', () => {
                ...
                expect(html_to_text_1.fromString(testString)).toEqual(' a. foo\n b. bar');
            });
            it('should support the ordered list type="A" attribute', () => {
                const testString = '<ol type="A"><li>foo</li><li>bar</li></ol>';
                expect(html_to_text_1.fromString(testString)).toEqual(' A. foo\n B. bar');
            ...
            it('should support the ordered list start attribute', () => {
                ...
                expect(html_to_text_1.fromString(testString)).toEqual(' 2. foo\n 3. bar');
            });
      ...
      ';
            ...
            const result = html_to_text_1.fromString(html, { wordwrap: false });
            expect(result).toEqual(resultExpected);
        });
    });
    describe('entities', () => {
        it('does not insert null bytes', () => {
            ...
            const result = html_to_text_1.fromString(html);
    ...
    describe('unicode support', () => {
        it('should decode &#128514; to 😂', () => {
            const result = html_to_text_1.fromString('&#128514;');
    ...
    describe('disable uppercaseHeadings', () => {
        [1, 2, 3, 4, 5, 6].forEach((i) => {
            it('should return h' + i + ' in lowercase', () => {
                const result = html_to_text_1.fromString('<h' + i + '>test</h' + i + '>', {
    ...
    describe('custom formatting', () => {
        it('should allow to pass custom formatting functions', () => {
            const result = html_to_text_1.fromString('<h1>TeSt</h1>', {
                format: {
    ...
    describe('Base element', () => {
        it('should retrieve and convert the entire document under `body` by default', () => {
            ...
            const text = html_to_text_1.fromString(htmlFile, options);
    ...
    describe('Long words', () => {
        it('should split long words if forceWrapOnLimit is set, existing linefeeds converted to space', () => {
            ...
            expect(html_to_text_1.fromString(testString, {
        ...
        it('should not wrap a string if longWordSplit is not set', () => {
            ...
            expect(html_to_text_1.fromString(testString, {})).toEqual('_This_string_is_meant_to_test_if_a_string_is_split_properly_across_anewlineandlongword_with_following_text.');
        });
        ...
        it('should not put in extra linefeeds if the end of the untouched long string coincides with a preserved line feed', () => {
            const testString = '<p>_This_string_is_meant_to_test_if_a_string_is_split_properly_across_anewlineandlong\nword_with_following_text.</p>';
            expect(html_to_text_1.fromString(testString, { preserveNewlines: true })).toEqual('_This_string_is_meant_to_test_if_a_string_is_split_properly_across_anewlineandlong\nword_with_following_text.');
        });
    ...
    describe('whitespace', () => {
        it('should not be ignored inside a whitespace-only node', () => {
            ...
            expect(html_to_text_1.fromString(testString)).toEqual('foo bar');
        });
        it('should not add additional whitespace after <sup>', () => {
            ...
            expect(html_to_text_1.fromString(testString, options)).toEqual('This text contains superscript text.');
        });
    });
    describe('wbr', () => {
        it('should handle a large number of wbr tags w/o stack overflow', () => {
            ...
            expect(html_to_text_1.fromString(testString)).toEqual(expectedResult);
        });
    });
    describe('blockquote', () => {
